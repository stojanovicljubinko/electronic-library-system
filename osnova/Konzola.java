...
public class Konzola implements Runnable {

    public void run() {
        System.out.print("\nyou personal java girlfriend assistent->");
        String commandLine;
        ...
        List<String> commandsList = Arrays.asList("history", "song", "game", "calculate", "givelove", "turnoff", "turnoffyes", "hey", "hi", "hello");
        int index = 0;
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    if (love > 60) {
                        if (list.contains("bookwrite")) {
                            love += -5;
                            Random r = new Random();
                            int pitanje = r.nextInt(5);
                            if (pitanje == 0) {
                                System.out.println("you open, i don't want");
                            } else if (pitanje == 1) {
                ...
                } //catch ioexception, output appropriate message, resume waiting for input //catch ioexception, output appropriate message, resume waiting for input //catch ioexception, output appropriate message, resume waiting for input //catch ioexception, output appropriate message, resume waiting for input
                catch (IOException e) {
